...
N.Delay = class {
  constructor(callback, delay) {
    this.cb = callback, this.d = delay, N.BM(this, ["loop"]), this.raf = new N.RafR(this.loop)
  }
  run() {
  ...
  loop(t) {
    t = N.Clamp(t, 0, this.d);
    1 === N.Clamp(t / this.d, 0, 1) && (this.stop(), this.cb())
  }
}
N.TL = class {
  constructor() {
  ...
  from(t) {
    this.del += N.Has(t, "delay") ? t.delay : 0, t.delay = this.del, this.arr.push(new N.M(t))
  }
  play(t) {
    this.run("play", t)
  }
...
const Tab = class {
  constructor() {
    this.arr = [], this.pause = 0, N.BM(this, ["v"]), N.L(document, "a", "visibilitychange", this.v)
  }
  add(t) {
    this.arr.push(t)
  }
...
// const Raf = (N.Tab = new Tab, N.Raf = class {
//   constructor() {
//     this.arr = [],
//       this.on = !0,
...
//     this.cb = callback, this.on = !1, this.id = RafId, RafId++
//   }
//   run() {
...
// t.d optionel? delay peut etre, bon peut etre pas
// t.delay
// t.cb callback
// t.r
// t.p ??
...
// N.M = class {
//   constructor(t) {
//     N.BM(this, ["gRaf", "run", "uSvg", "uLine", "uProp"]), this.v = this.vInit(t), this.raf = new N.RafR(this.run)
//   }
//   vInit(r) {
//     const i = {
//       el: N.Select.el(r.el),
...
//     for (let t = 0; t < this.v.elL && !N.Is.und(this.v.el[t]); t++) 0 !== h && (this.v.el[t].style.transform = h), 0 <= l && (this.v.el[t].style.opacity = l)
//   }
//   uSvg() {
//     const r = this.v.svg;
//     r.currTemp = "";
...
//   }
//   lerp(t, r) {
//     return N.R(N.Lerp(t, r, this.v.progE), this.v.r)
//   }
// }
